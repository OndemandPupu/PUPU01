...
<c:forEach var="obj" items="${list }" varStatus="status">
	<div class="w3-container w3-card-2 w3-white w3-round w3-margin">
		...
		<h6 class="w3-opacity">
			<a href="/profile?name=${obj.get('ID')}"> <b>${obj.get("NAME") }</b>(${obj.get("ID") })${status.count }님
			</a><input type="button" value="삭제" style="float:right" onclick="delwrite('${obj.FILEUUID}')"/>
		</h6> 
		...
		<div class="w3-row-padding" style="margin: 0 -16px">
			<div class="w3-half">
				...
				<button type="button" id="filemodal"
					...
					onclick="button1_click('${obj.FILEUUID}', '${obj.ID }' );">
		...
		reader.onload = (function(theFile) {
			return function(e) {
				...
				var img_view = [ '<img src="', e.target.result, '" title="',
						escape(theFile.name),
						'"  style= "width:200px;height:200px;  " />' ].join('');
